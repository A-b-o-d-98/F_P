...
useEffect  (async ()=> {
  ...
  const a =await axiosInstance.post('/islogged',UserInfo)
     await a.then((res)=>{ 
    ...
    var z ;
        ...
        const x = axiosInstance.post('/test',{TableName:TableName});
        await x.then((result)=>{
...
const f =()=>{
      ...
      const x = axiosInstance.post('/test/res' , {user : user , result : result , testName : testName });
...
{  const next = document.getElementById('next'); 
   ...
   const letsgo =async ()=>{
    ...
    const Username = window.localStorage.getItem('username') 
    const date = axiosInstance.post('/islogged' , {desc:"times of test" , username : Username });
  ...
  const next = document.getElementById('next'); 
   ...
   const getResult = async()=>{
    ...
    const UserInfo = { username : username , result :result }
         ...
         const z  = axiosInstance.post('/test/results',UserInfo)
         await z.then((res)=>{
